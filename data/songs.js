export const songs = [
  {
    ...
    "chordsHTML": (<pre data-key="G#m" className="chords" id="key"><span>Intro:</span>
      ...
      <span></span>
      <span><span className="c">G#m</span>                                      <span className="c">E</span>                    <span className="c">D#</span></span>
      <span>İstedim, hep istedim, bu hislerim, karabatak </span>
      <span><span className="c">G#m</span>                                              <span className="c">E</span>                    <span className="c">D#</span></span>
      <span>Derinlere batmış taştan kalp, sesi çıkmaz, yapayalnız </span>
      <span><span className="c">G#m</span>                                  <span className="c">E</span>                  <span className="c">D#</span></span>
      <span>Akşamüstü hep genciz, gece gelir gemi batar </span>
      <span><span className="c">G#m</span>                                    <span className="c">E</span>                     <span className="c">D#</span></span>
      <span>Viranelerde sofralar, kurup çürük meyvelerle </span>
      <span></span>
      <span><span className="c">G#m</span>    <span className="c">F#</span></span>
      <span></span>
      <span><span className="c">G#m</span>                   </span>
      <span>Aşkına bomba, çay çorba </span>
      <span><span className="c">F#</span></span>
      <span>Başımızda krallar yolumuza tükürür </span>
      <span><span className="c">G#m</span></span>
      <span>Yakalayıp bi ucunu sal boşluğa </span>
      <span><span className="c">F#m</span> </span>
      <span>Çözülmeye hasret düğümün </span>
      <span></span>
      <span><span className="c">G#m</span>  <span className="c">C#m</span>  <span className="c">D#m</span>   <span className="c">C#m</span></span>
      <span>Ne kralın tacı </span>
      <span><span className="c">G#m</span>       <span className="c">C#m</span>    <span className="c">D#m</span>   <span className="c">C#m</span></span>
      <span>Ne kısa günün kazancı </span>
      <span><span className="c">G#m</span>  <span className="c">C#m</span>  <span className="c">D#m</span>   <span className="c">C#m</span></span>
      <span>Garibin   harcı </span>
      <span><span className="c">G#m</span>  <span className="c">C#m</span>  <span className="c">D#m</span>   <span className="c">C#m</span></span>
      <span>Acının ilacı, acının ilacı</span>
      <span></span>
      <span><span className="c">G#m</span>                                         <span className="c">E</span>                    <span className="c">D#</span></span>
      <span>Kim kimin deli gözlerin, bu iklimin sonu mu var </span>
      <span><span className="c">G#m</span>                                      <span className="c">E</span>                               <span className="c">D#</span></span>
      <span>Zehir karışmış topraklar, mühür vurmuşlar kalbine </span>
      <span><span className="c">G#m</span>                                       <span className="c">E</span>                   <span className="c">D#</span></span>
      <span>Olancası bir tutam can, dahası kof, yarını yok </span>
      <span><span className="c">G#m</span>                                      <span className="c">E</span>                    <span className="c">D#</span></span>
      <span>Garibin başında rüzgar, halimizden yanan anlar </span>
      <span></span>
      <span><span className="c">G#m</span>    <span className="c">F#</span></span>
      <span></span>
      <span><span className="c">G#m</span></span>
      <span>Kaderime kederime razıyım ederime </span>
      <span><span className="c">F#</span></span>
      <span>Gönlünü duy, söyle dileğini </span>
      <span><span className="c">G#m</span></span>
      <span>Bahçemiz olsun dilimizi yutsun </span>
      <span><span className="c">E</span>         <span className="c">D#</span>     <span className="c">C#m</span>    <span className="c">B</span>              <span className="c">A</span></span>
      <span>Bilen çözer elbet bir gün düğümleri</span>
      <span></span>
      <span><span className="c">G#m</span>  <span className="c">C#m</span>  <span className="c">D#m</span>   <span className="c">C#m</span></span>
      <span>Ne kralın tacı </span>
      <span><span className="c">G#m</span>       <span className="c">C#m</span>    <span className="c">D#m</span>   <span className="c">C#m</span></span>
  ...
  },
  {
    ...
    "chordsHTML": (
      <pre className="tK8GG Ty_RP" ><span className="y68er">[Intro/Riff]
          ...
          </span></span><span className="fsG7q"><span className="y68er"><span data-name="C5" className="fciXY _Oy28" >C5</span> /       <span data-name="Ab5" className="fciXY _Oy28" >Ab5</span> /
          ...
          </span><span className="y68er">Funky Claude was running in and out
          </span></span><span className="fsG7q"><span className="y68er"><span data-name="G5" className="fciXY _Oy28" >G5</span> /         <span data-name="F5" className="fciXY _Oy28" >F5</span> /
          </span><span className="y68er">Pulling kids out the ground
          </span></span><span className="fsG7q"><span className="y68er"><span data-name="G5" className="fciXY _Oy28" >G5</span> /          <span data-name="G5" className="fciXY _Oy28" >G5</span> /
          </span><span className="y68er">When it all was over
          </span></span><span className="fsG7q"><span className="y68er">   <span data-name="G5" className="fciXY _Oy28" >G5</span> /        <span data-name="F5" className="fciXY _Oy28" >F5</span> /    <span data-name="G5" className="fciXY _Oy28" >G5</span> /
          </span><span className="y68er">We had to find another place
          </span></span><span className="fsG7q"><span className="y68er"><span data-name="G5" className="fciXY _Oy28" >G5</span> /             <span data-name="G5" className="fciXY _Oy28" >G5</span> /
          </span><span className="y68er">But Swiss time was running out
          </span></span><span className="fsG7q"><span className="y68er">   <span data-name="G5" className="fciXY _Oy28" >G5</span> /                 <span data-name="F5" className="fciXY _Oy28" >F5</span> /     <span data-name="G5" className="fciXY _Oy28" >G5</span> /
          </span><span className="y68er">It seemed that we would lose the race
          </span></span><span className="y68er">
        </span><span className="y68er">
        </span><span className="y68er">[Chorus]
        </span><span className="y68er">
        ...
        </span><span className="y68er">[Solo]
        </span><span className="y68er">
        </span><span className="y68er">|<span data-name="G5" className="fciXY _Oy28" >G5</span> /|<span data-name="G5" className="fciXY _Oy28" >G5</span> /|<span data-name="C5" className="fciXY _Oy28" >C5</span> /|<span data-name="G5" className="fciXY _Oy28" >G5</span> /|
        </span><span className="y68er">|<span data-name="G5" className="fciXY _Oy28" >G5</span> /|<span data-name="G5" className="fciXY _Oy28" >G5</span> /|<span data-name="C5" className="fciXY _Oy28" >C5</span> /|<span data-name="G5" className="fciXY _Oy28" >G5</span> /|
        </span><span className="y68er">|<span data-name="G5" className="fciXY _Oy28" >G5</span> /|<span data-name="G5" className="fciXY _Oy28" >G5</span> /|<span data-name="C5" className="fciXY _Oy28" >C5</span> /|<span data-name="G5" className="fciXY _Oy28" >G5</span> /|
        </span><span className="y68er">|<span data-name="G5" className="fciXY _Oy28" >G5</span> /|<span data-name="G5" className="fciXY _Oy28" >G5</span> /|<span data-name="C5" className="fciXY _Oy28" >C5</span> /|<span data-name="G5" className="fciXY _Oy28" >G5</span> /|
        </span><span className="y68er">|<span data-name="C5" className="fciXY _Oy28" >C5</span> /|<span data-name="C5" className="fciXY _Oy28" >C5</span> /|<span data-name="F5" className="fciXY _Oy28" >F5</span> /|<span data-name="F5" className="fciXY _Oy28" >F5</span> /|
        </span><span className="y68er">
        </span><span className="y68er">
        </span><span className="y68er">[Riff]
        </span><span className="y68er">
        </span><span className="y68er">[Verse 3]
        </span><span className="y68er">
        </span><span className="fsG7q"><span className="y68er"><span data-name="G5" className="fciXY _Oy28" >G5</span> /             <span data-name="G5" className="fciXY _Oy28" >G5</span> /
        </span><span className="y68er">We ended up at the Grand Hotel
          </span></span><span className="fsG7q"><span className="y68er"><span data-name="G5" className="fciXY _Oy28" >G5</span> /   <span data-name="F5" className="fciXY _Oy28" >F5</span> /  <span data-name="G5" className="fciXY _Oy28" >G5</span> /
          </span><span className="y68er">It was empty cold and bare
          </span></span><span className="fsG7q"><span className="y68er"><span data-name="G5" className="fciXY _Oy28" >G5</span> /                     <span data-name="G5" className="fciXY _Oy28" >G5</span> /
          </span><span className="y68er">But with the Rolling truck Stones thing just outside
          </span></span><span className="fsG7q"><span className="y68er"><span data-name="G5" className="fciXY _Oy28" >G5</span> /       <span data-name="F5" className="fciXY _Oy28" >F5</span> /  <span data-name="G5" className="fciXY _Oy28" >G5</span> /
          </span><span className="y68er">Making our music there
          </span></span><span className="fsG7q"><span className="y68er">       <span data-name="G5" className="fciXY _Oy28" >G5</span> /               <span data-name="G5" className="fciXY _Oy28" >G5</span> /
          </span><span className="y68er">With a few red lights and a few old beds
          </span></span><span className="fsG7q"><span className="y68er"><span data-name="G5" className="fciXY _Oy28" >G5</span> /      <span data-name="F5" className="fciXY _Oy28" >F5</span> /     <span data-name="G5" className="fciXY _Oy28" >G5</span> /
          </span><span className="y68er">We make a place to sweat
          </span></span><span className="fsG7q"><span className="y68er"><span data-name="G5" className="fciXY _Oy28" >G5</span> /            <span data-name="G5" className="fciXY _Oy28" >G5</span> /
          </span><span className="y68er">No matter what we get out of this
          </span></span><span className="fsG7q"><span className="y68er"><span data-name="G5" className="fciXY _Oy28" >G5</span> /    <span data-name="F5" className="fciXY _Oy28" >F5</span> /         <span data-name="G5" className="fciXY _Oy28" >G5</span> /
          </span><span className="y68er">I know, I know we ll never forget
          </span></span><span className="y68er">
        </span><span className="y68er">
        </span><span className="y68er">[Chorus]
        </span><span className="y68er">
        ...
        </span><span className="y68er">[Instrumental Verse] fade out
        </span><span className="y68er">
        </span><span className="y68er">
        </span><span className="y68er">In the Intro/Riff, I mean a two-note chord played
        </span><span className="y68er">
        </span><span className="y68er">D4 is x55xxx
        </span><span className="y68er">F4 is xx33xx
        </span><span className="y68er">G4 is xx55xx
        </span><span className="y68er">Ab4 is xx66xx.
  ...
  },
  {
    ...
    "artist": "Umut Kaya",
    "title": "Mor Yazma",
    "chordsHTML": (<pre data-key="C#m" className="chords" id="key"><span><span className="c">C#m</span>                             <span className="c">A</span>          <span className="c">G#</span></span>
      <span>Kaldım şehirlerde sen bana kızma               </span>
      <span><span className="c">C#m</span>                                     <span className="c">A</span>               <span className="c">G#</span></span>
      <span>Hep haber edemezsem moralini bozma             </span>
      <span><span className="c">C#m</span>                             <span className="c">A</span>          <span className="c">G#</span></span>
      <span>Bilmiyom ne zaman geri gelcem</span>
      <span><span className="c">C#m</span>                               <span className="c">A</span>       <span className="c">G#</span>     <span className="c">F#m</span></span>
      <span>Alcam o yerlerden sana mor yazma</span>
      <span><span className="c">C#m</span></span>
      <span>Sana mor yazma</span>
      <span></span>
      <span><span className="c">C#m</span>    <span className="c">A</span>    <span className="c">E</span>    <span className="c">G#</span>  </span>
      <span></span>
      <span><span className="c">C#m</span>              <span className="c">A</span>                           <span className="c">E</span>                    <span className="c">G#</span>  </span>
      <span>Aşık oldum kapıldım hissine istedim babandan</span>
      <span><span className="c">C#m</span>                           <span className="c">A</span>                                  <span className="c">E</span>                          <span className="c">G#</span>  </span>
      <span>Buyum ben dedim bak hiç tükenmedim düşmedim yakandan  </span>
      <span><span className="c">C#m</span>                            <span className="c">A</span>                        <span className="c">E</span>                      <span className="c">G#</span>          </span>
      <span>Bak ne hale geldim tövbeler ettim nefsimi kuruttum      </span>
      <span><span className="c">C#m</span>                 <span className="c">A</span>                        <span className="c">E</span>                            <span className="c">G#</span>          </span>
      <span>Eskileri attım alemi bıraktım alamadım babandan             </span>
      <span></span>
      <span><span className="c">A</span>              <span className="c">G#</span>           <span className="c">C#m</span>   <span className="c">A</span>           <span className="c">G#</span>         <span className="c">A</span> </span>
      <span>Napsam ne etsem ben Koptum gittim ben</span>
      <span>         <span className="c">G#</span>        <span className="c">A</span>  <span className="c">G#</span></span>
      <span>Üzülme sen  </span>
      <span></span>
      <span><span className="c">C#m</span>                             <span className="c">A</span>          <span className="c">G#</span></span>
      <span>Kaldım şehirlerde sen bana kızma               </span>
      <span><span className="c">C#m</span>                                     <span className="c">A</span>               <span className="c">G#</span></span>
  ...
  },
  {
    ...
    "chordsHTML": (<pre data-key="Dm" className="chords" id="key"><span><span className="c">Dm</span>   <span className="c">Bb</span>         <span className="c">F</span>       <span className="c">C</span></span>
      <span>Bak benden arta kalan</span>
      <span><span className="c">Dm</span>    <span className="c">Bb</span>     <span className="c">F</span>         <span className="c">C</span></span>
      <span>Biraz kül  biraz duman</span>
      <span><span className="c">Dm</span>  <span className="c">Bb</span>     <span className="c">F</span>           <span className="c">C</span></span>
      <span>Ne kadar istesem de</span>
      <span><span className="c">Bb</span>                   <span className="c">A</span></span>
      <span>Ben seni arayamam</span>
      <span></span>
      <span><span className="c">Dm</span>        <span className="c">Bb</span>     <span className="c">F</span>        <span className="c">C</span></span>
      <span>Ruhum rüyaya dalmış</span>
      <span><span className="c">Dm</span>      <span className="c">Bb</span>       <span className="c">F</span>            <span className="c">C</span></span>
      <span>Dünya uzak, gerçek yavan</span>
      <span><span className="c">Dm</span>     <span className="c">Bb</span>          <span className="c">F</span>            <span className="c">C</span></span>
      <span>Sanki bir yok bir de varmış</span>
      <span><span className="c">Bb</span>                    <span className="c">A</span></span>
      <span>Ben seni arayamam    </span>
      <span></span>
      <span><span className="c">Gm</span>                 <span className="c">C</span></span>
      <span>Keşke yanımda olsaydın</span>
      <span><span className="c">A</span>             <span className="c">Dm</span>           <span className="c">C</span></span>
      <span>Kolay olurdu o zaman</span>
      <span><span className="c">Bb</span>                                 <span className="c">C</span></span>
      <span>Ben sussam sen anlatsaydın</span>
      <span><span className="c">A</span></span>
      <span>Yorulunca uyusaydın</span>
      <span></span>
      <span><span className="c">Dm</span>   <span className="c">Bb</span>     <span className="c">F</span>       <span className="c">C</span>  </span>
      <span>Kolay mı sanıyorsun</span>
      <span><span className="c">Dm</span>  <span className="c">Bb</span>    <span className="c">F</span>            <span className="c">C</span></span>
      <span>Kolaysa yan o zaman</span>
      <span><span className="c">Dm</span>      <span className="c">Bb</span>        <span className="c">F</span>       <span className="c">C</span></span>
      <span>Yağmurum ol in üstüme</span>
      <span><span className="c">Dm</span>    <span className="c">Bb</span>            <span className="c">A</span></span>
      <span>Ben böyle yaşayamam</span>
      <span></span>
      <span><span className="c">Dm</span>    <span className="c">Bb</span>     <span className="c">F</span>   <span className="c">C</span></span>
      <span>Halimi  görüyorsun</span>
      <span><span className="c">Dm</span>   <span className="c">Bb</span>      <span className="c">F</span>          <span className="c">C</span></span>
      <span>Bir şeyler yap o zaman</span>
      <span><span className="c">Dm</span>           <span className="c">Bb</span>  <span className="c">F</span>      <span className="c">C</span></span>
      <span>Sebebim var biliyorsun</span>
      <span><span className="c">Dm</span>   <span className="c">Bb</span>        <span className="c">A</span></span>
  ...
  },
  {
    ...
    "chordsHTML": (<pre data-key="B" className="chords " id="key"><span><span className="c">Em</span></span>
      ...
      <span> </span>
      <span>Neler gördüm görmedim</span>
      <span><span className="c">Am</span></span>
      <span>Şu kocaman dünya da</span>
      <span><span className="c">G</span>         <span className="c">F</span>                <span className="c">Em</span></span>
      <span>Senin gibi görmedim</span>
      <span> </span>
      <span><span className="c">Em</span>              <span className="c">Em</span>              <span className="c">Em</span></span>
      <span>Sağdan soldan estarabim- Nak.</span>
      <span><span className="c">Em</span>    <span className="c">Em</span>   <span className="c">Em</span>    <span className="c">Em</span></span>
      <span>Aum Aum Aum Aum </span>
      <span></span>
      <span> </span>
      <span><span className="c">Em</span></span>
      <span>Böyle bir yar istemem</span>
      <span> </span>
      <span>İstesemde istemem</span>
      <span><span className="c">Am</span></span>
      <span>Güller bitti dilimde</span>
      <span><span className="c">G</span>         <span className="c">F</span>                <span className="c">Em</span></span>
      <span>Nasıl diyeyim bilmem</span>
      <span> </span>
      <span>Nak.</span>
      <span> </span>
      <span><span className="c">Em</span></span>
      <span>Ateş olmayan yerde</span>
      <span> </span>
      <span>Duman tütmezmiş derler</span>
      <span><span className="c">Am</span></span>
      <span>Zaman zaman halini</span>
      <span><span className="c">G</span>         <span className="c">F</span>                <span className="c">Em</span></span>
      <span>Bir görseler gülerler.</span>
      <span> </span>
      <span>Nak.</span></pre>)
  },
  {
    ...
    "chordsHTML": (<pre data-key="Gm" className="chords" id="key"><span><span className="c">Gm</span>                             <span className="c">Eb</span>  <span className="c">D</span>                        <span className="c">Gm</span>  <span className="c">F</span>  <span className="c">Eb</span></span>
      <span>Benim gönlüm sarhoştur yıldızların altında</span>
      <span><span className="c">Eb</span>                        <span className="c">Cm</span>        <span className="c">D</span>                    <span className="c">Gm</span>                      </span>
      <span>Sevişmek ah ne hoştur yıldızların altında   </span>
      <span></span>
      <span><span className="c">Gm</span>                             <span className="c">Eb</span>  <span className="c">D</span>                        <span className="c">Gm</span>  <span className="c">F</span>  <span className="c">Eb</span></span>
      <span>Mavi nurdan bir ırmak gölgede bir salıncak</span>
      <span><span className="c">Eb</span>                   <span className="c">Cm</span>        <span className="c">D</span>                    <span className="c">Gm</span>                      </span>
      <span>Bir de ikimiz kalsak yıldızların altında</span>
      <span></span>
      <span><span className="c">Gm</span>                      <span className="c">F</span>                <span className="c">Cm</span>              <span className="c">Bb</span></span>
      <span>Yanmam gönlüm yansa da ecel beni alsa da</span>
      <span><span className="c">Eb</span>                      <span className="c">Bb</span>         <span className="c">D</span>                    <span className="c">Gm</span></span>
      <span>Gözlerim kapansa da yıldızların altında</span>
      <span><span className="c">Gm</span>                      <span className="c">F</span>                <span className="c">Cm</span>              <span className="c">Bb</span></span>
      <span>Yanmam gönlüm yansa da ecel beni alsa da</span>
      <span><span className="c">Eb</span>                      <span className="c">Bb</span>         <span className="c">D</span>                    <span className="c">Gm</span></span>
      <span>Gözlerim kapansa da yıldızların altında</span>
      ...
      <span>Gözlerim kapansa da yıldızların altında  </span>
      <span> </span>
      <span><span className="c">Gm</span>    <span className="c">Eb</span>    <span className="c">D</span></span></pre>)
  },
  {
    "id": 9,
    "artist": "Kıraç",
    ...
    "chordsHTML": (<pre data-key="Bm" className="chords" id="key"><span><span className="c">Bm</span>                                              <span className="c">Em</span> </span>
      ...
      <span>Hiç umulmaz nerelerde, tek başıma sersefilim  </span>
      <span><span className="c">Bm</span>                                      <span className="c">Em</span> </span>
      <span>Bir garip aşk bestesiyim, öyle içten öyle serin </span>
      <span><span className="c">Bm</span>                <span className="c">G</span>                   <span className="c">F#</span>                                   <span className="c">Bm</span></span>
      <span>Aklın almaz dayanılmaz, tek başıma çok sefilim</span>
      <span></span>
      <span><span className="c">Bm</span>                                              <span className="c">Em</span> </span>
      <span>Ben bir garip aşk bestesiyim, bilemezsin ne haldeyim</span>
      <span><span className="c">Bm</span>               <span className="c">G</span>                  <span className="c">F#</span>                                     </span>
      <span>Çok uzakta bir şehirde, bıraktığın serseriyim</span>
      <span><span className="c">Bm</span>                                      <span className="c">Em</span> </span>
      <span>Bir garip aşk bestesiyim, yalnız senin tek seninim</span>
      <span><span className="c">Bm</span>             <span className="c">G</span>                     <span className="c">F#</span>                                          <span className="c">Bm</span> </span>
      <span>Arama hiç başka yerde, bende gülüm aşk dediğin  </span>
      <span></span>
      <span><span className="c">Bm</span>                                   </span>
      <span>Duyulmamış hiçbir yerde, söylenmemiş kimselere    </span>
      <span><span className="c">Em</span>                                     <span className="c">C</span>                     <span className="c">F#</span> </span>
      <span>Sen uyurken gecelerce, her yerinde aşk yeliyim</span>
      <span><span className="c">Bm</span>                                   </span>
      <span>Duyulmamış hiçbir yerde, söylenmemiş kimselere    </span>
      <span><span className="c">Em</span>                                    <span className="c">Bm</span>      <span className="c">C#</span>      <span className="c">F#</span>      <span className="c">Em</span>      <span className="c">G</span>             <span className="c">F#</span></span>
      <span>Sen uyurken gecelerce, senin senin senin senin için deliyim</span></pre>)
  },
  {
    "id": 10,
    "artist": "Haluk Levent",
  ...
  },
  {
    ...
    "artist": "Pinhani",
    "title": "Hele Bir Gel",
    "chordsHTML": (<pre data-key="Am" className="chords" id="key"><span>Intro:</span>
      <span><span className="c">F</span>    <span className="c">Dm</span>    <span className="c">E</span>    <span className="c">Am</span></span>
      <span></span>
      <span><span className="c">Am</span>                                   <span className="c">Dm</span></span>
      <span>İçinden geleni söyle, kalırsa yazık olur</span>
      <span><span className="c">F</span>                                          <span className="c">E</span></span>
      <span>Hayata küsüverirsin, hüzünler seni bulur</span>
      <span><span className="c">Am</span>                                   <span className="c">Dm</span></span>
      <span>Bi şeyler yapabilirsem güzel gözlerin için</span>
      <span><span className="c">F</span>                                          <span className="c">E</span></span>
      <span>Başından geçeni anlat, masaldır benim için             </span>
      <span></span>
      <span>          <span className="c">F</span>  <span className="c">Dm</span>  <span className="c">E</span>                  <span className="c">Am</span></span>
      <span>Hele bi gel, uzaklar sana gelir</span>
      <span>                  <span className="c">F</span>   <span className="c">Dm</span>          <span className="c">E</span>              <span className="c">Am</span></span>
      <span>Sen hele bi gel, tüm dertler bitiverir</span>
      <span>                 <span className="c">F</span>  <span className="c">Dm</span>    <span className="c">E</span>                        <span className="c">Am</span></span>
      <span>Hep seni bulur, uzun zor sıkıcı günler</span>
      <span>                 <span className="c">F</span>   <span className="c">Dm</span>  <span className="c">E</span>             <span className="c">Am</span></span>
      <span>Yazık olur, hadi gel kurtar bizi</span></pre>)
  },
  {
    "id": 12,
    "artist": "Duman",
  ...
  },
  {
    ...
    "chordsHTML": (<pre data-key="Dm" className="chords" id="key"><span><span className="c">Dm</span>                         <span className="c">A</span>         </span>
      ...
      <span>              <span className="c">Dm</span>             </span>
      <span>Her yerde arayıp           </span>
      <span>                      <span className="c">A</span>              </span>
      <span>Yine de bulamamışsan       </span>
      <span>              <span className="c">Gm</span>           </span>
      <span>O seni unutmuş                  </span>
      <span>                   <span className="c">A</span>                    </span>
      <span>Sen unutamamışsan          </span>
      <span>                      <span className="c">Gm</span>     </span>
      <span>Kalbinin kuşu uçmuş        </span>
      <span>                 <span className="c">A</span>                 </span>
      <span>Sen tutamamışsan               </span>
      <span></span>
      <span>           <span className="c">Bm</span>                         <span className="c">A</span></span>
      <span>Haydi gel, haydi gel içelim</span>
      <span>                        <span className="c">Bm</span>                     <span className="c">A</span></span>
      <span>Derdini al da gel, haydi gel içelim</span>
      <span>                              <span className="c">Em</span>                              <span className="c">A</span>                          <span className="c">Bm</span>      <span className="c">A</span></span>
      <span>Bu evrende bir tozsun, tarih seni unutsun, haydi gel içelim</span>
      <span>               <span className="c">Bm</span>                       <span className="c">A</span></span>
      <span>Topla da gel, haydi gel içelim</span>
      <span>                      <span className="c">Bm</span>                      <span className="c">A</span></span>
      <span>Hepsini al da gel, haydi gel içelim</span>
      <span>              <span className="c">Em</span>                                              <span className="c">A</span>                            <span className="c">Bm</span>      <span className="c">A</span></span>
      <span>Mazi kalbinde yaraysa, unut artık ne varsa, haydi gel içelim</span>
      <span><span className="c">A</span>             <span className="c">Bm</span>  <span className="c">A</span></span>
      <span>Yerlere düşelim</span>
      <span><span className="c">A</span>          <span className="c">Bm</span>    <span className="c">A</span></span>
      <span>Haydi gel içelim</span>
      <span>           <span className="c">Bm</span></span>
  ...
  },
  {
    ...
    "chordsHTML": (<pre className="tK8GG Ty_RP" ><span className="y68er">[Verse]
        ...
        </span><span className="y68er">  couldn t be much more from the heart
        </span></span><span className="fsG7q"><span className="y68er"><span data-name="Em" className="fciXY _Oy28" >Em</span>                 <span data-name="D" className="fciXY _Oy28" >D</span>       <span data-name="C" className="fciXY _Oy28" >C</span>
        </span><span className="y68er">  forever trusting who we are
        </span></span><span className="fsG7q"><span className="y68er"><span data-name="G" className="fciXY _Oy28" >G</span>     <span data-name="B7" className="fciXY _Oy28" >B7</span>           <span data-name="Em" className="fciXY _Oy28" >Em</span>
        </span><span className="y68er">  and nothing else matters
        </span></span><span className="y68er">
      </span><span className="fsG7q"><span className="y68er"><span data-name="Em" className="fciXY _Oy28" >Em</span>               <span data-name="D" className="fciXY _Oy28" >D</span>            <span data-name="C" className="fciXY _Oy28" >C</span>
      </span><span className="y68er">  never opened myself this way
        </span></span><span className="fsG7q"><span className="y68er"><span data-name="Em" className="fciXY _Oy28" >Em</span>                         <span data-name="D" className="fciXY _Oy28" >D</span>      <span data-name="C" className="fciXY _Oy28" >C</span>
        </span><span className="y68er">  life is ours, we live it our way
        </span></span><span className="fsG7q"><span className="y68er"><span data-name="Em" className="fciXY _Oy28" >Em</span>                  <span data-name="D" className="fciXY _Oy28" >D</span>              <span data-name="C" className="fciXY _Oy28" >C</span>
        </span><span className="y68er">  all these words I don t just say
        </span></span><span className="fsG7q"><span className="y68er"><span data-name="G" className="fciXY _Oy28" >G</span>     <span data-name="B7" className="fciXY _Oy28" >B7</span>           <span data-name="Em" className="fciXY _Oy28" >Em</span>
        </span><span className="y68er">  and nothing else matters
        </span></span><span className="y68er">
      </span><span className="fsG7q"><span className="y68er"><span data-name="Em" className="fciXY _Oy28" >Em</span>                   <span data-name="D" className="fciXY _Oy28" >D</span>          <span data-name="C" className="fciXY _Oy28" >C</span>
      </span><span className="y68er">  trust I seek and I find in you
        </span></span><span className="fsG7q"><span className="y68er"><span data-name="Em" className="fciXY _Oy28" >Em</span>                 <span data-name="D" className="fciXY _Oy28" >D</span>            <span data-name="C" className="fciXY _Oy28" >C</span>
        </span><span className="y68er">  every day for us something new
        </span></span><span className="fsG7q"><span className="y68er"><span data-name="Em" className="fciXY _Oy28" >Em</span>                <span data-name="D" className="fciXY _Oy28" >D</span>             <span data-name="C" className="fciXY _Oy28" >C</span>
        </span><span className="y68er">  open mind for a different view
        </span></span><span className="fsG7q"><span className="y68er"><span data-name="G" className="fciXY _Oy28" >G</span>     <span data-name="B7" className="fciXY _Oy28" >B7</span>           <span data-name="Em" className="fciXY _Oy28" >Em</span>      <span data-name="C" className="fciXY _Oy28" >C</span>  <span data-name="A" className="fciXY _Oy28" >A</span>
        </span><span className="y68er">  and nothing else matters
        </span></span><span className="y68er">
      </span><span className="y68er">[Chorus]
      </span><span className="fsG7q"><span className="y68er"><span data-name="D" className="fciXY _Oy28" >D</span>                        <span data-name="C" className="fciXY _Oy28" >C</span>  <span data-name="A" className="fciXY _Oy28" >A</span>
      </span><span className="y68er">never cared for what they do
        </span></span><span className="fsG7q"><span className="y68er"><span data-name="D" className="fciXY _Oy28" >D</span>                        <span data-name="C" className="fciXY _Oy28" >C</span>  <span data-name="A" className="fciXY _Oy28" >A</span>
        </span><span className="y68er">never cared for what they know
        </span></span><span className="fsG7q"><span className="y68er"><span data-name="D" className="fciXY _Oy28" >D</span>     <span data-name="Em" className="fciXY _Oy28" >Em</span>
        </span><span className="y68er">but I know
        </span></span><span className="y68er">
      </span><span className="y68er">[Verse]
      </span><span className="fsG7q"><span className="y68er"><span data-name="Em" className="fciXY _Oy28" >Em</span>                   <span data-name="D" className="fciXY _Oy28" >D</span>      <span data-name="C" className="fciXY _Oy28" >C</span>
      </span><span className="y68er">  So close no matter how far
        </span></span><span className="fsG7q"><span className="y68er"><span data-name="Em" className="fciXY _Oy28" >Em</span>                      <span data-name="D" className="fciXY _Oy28" >D</span>             <span data-name="C" className="fciXY _Oy28" >C</span>
        </span><span className="y68er">  couldn t be much more from the heart
        ...
        </span><span className="y68er">  and nothing else matter-ers
        </span></span><span className="y68er">
      </span><span className="y68er">[Chorus]
      </span><span className="fsG7q"><span className="y68er"><span data-name="D" className="fciXY _Oy28" >D</span>                        <span data-name="C" className="fciXY _Oy28" >C</span>  <span data-name="A" className="fciXY _Oy28" >A</span>
      </span><span className="y68er">never cared for what they say
        </span></span><span className="fsG7q"><span className="y68er"><span data-name="D" className="fciXY _Oy28" >D</span>                        <span data-name="C" className="fciXY _Oy28" >C</span>  <span data-name="A" className="fciXY _Oy28" >A</span>
        </span><span className="y68er">never cared for games they play
        </span></span><span className="fsG7q"><span className="y68er"><span data-name="D" className="fciXY _Oy28" >D</span>                        <span data-name="C" className="fciXY _Oy28" >C</span>  <span data-name="A" className="fciXY _Oy28" >A</span>
        </span><span className="y68er">never cared for what they do
        </span></span><span className="fsG7q"><span className="y68er"><span data-name="D" className="fciXY _Oy28" >D</span>                        <span data-name="C" className="fciXY _Oy28" >C</span>  <span data-name="A" className="fciXY _Oy28" >A</span>
        </span><span className="y68er">never cared for what they know
        </span></span><span className="fsG7q"><span className="y68er"><span data-name="D" className="fciXY _Oy28" >D</span>     <span data-name="Em" className="fciXY _Oy28" >Em</span>
        </span><span className="y68er">and I know
        </span></span><span className="y68er">
      </span><span className="y68er">[Verse]
      </span><span className="fsG7q"><span className="y68er"><span data-name="Em" className="fciXY _Oy28" >Em</span>                   <span data-name="D" className="fciXY _Oy28" >D</span>      <span data-name="C" className="fciXY _Oy28" >C</span>
      </span><span className="y68er">  So close no matter how far
        ...
        </span><span className="y68er">  no, nothing else matters
        </span></span><span className="y68er">
      </span><span className="y68er">[Outro]
      </span><span className="y68er"><span data-name="Em" className="fciXY _Oy28" >Em</span>
      </span><div className="LJhrL">X</div></pre>)
  },
  {
    "id": 24,
    ...
    "chordsHTML": (<pre data-key="Am" className="chords" id="key"><span><span className="c">E</span>    <span className="c">Dm</span>    <span className="c">C</span>    <span className="c">E</span> </span>
      ...
      <span></span>
      <span><span className="c">E</span>                             <span className="c">Dm</span>                         <span className="c">F</span>                      <span className="c">E</span></span>
      <span>Bir sevgili uğruna sen de benim gibi yanma arkadaş</span>
      <span><span className="c">Am</span>                            <span className="c">G</span>                       <span className="c">F</span>                     <span className="c">E</span> </span>
      <span>O yaşlı gözlerine o yalan sözlerine kanma arkadaş </span>
      <span></span>
      <span><span className="c">Am</span></span>
      <span>Giden gelir mi sandın</span>
      <span>Aldandın boşa yandın </span>
      <span>Bırakıp gitti seni </span>
      <span><span className="c">G</span></span>
      <span>Niçin ismini andın </span>
      <span><span className="c">F</span>                        <span className="c">E</span></span>
      <span>Anma arkadaş anma arkadaş </span>
      <span></span>
      <span><span className="c">E</span>                                 <span className="c">Dm</span>                            <span className="c">F</span>                       <span className="c">E</span></span>
      <span>Bir gün geri gelecek senden af dileyecek sanma arkadaş</span>
      <span><span className="c">Am</span>                             <span className="c">G</span>                           <span className="c">F</span>                    <span className="c">E</span></span>
  ...
  },
  {
    ...
    "title": "Bir",
    "chordsHTML": (<pre data-key="Dm" className="chords" id="key"><span><span className="c">Dm</span>          </span>
      <span>Ateş toprak hava olmuş </span>
      <span><span className="c">C</span>                             <span className="c">Bb</span>              <span className="c">Dm</span></span>
      <span>Yağmur olmuş hayat vermiş sana </span>
      <span><span className="c">Dm</span>           </span>
      <span>Kalbin olmuş ruhun olmuş </span>
      <span><span className="c">C</span>                         <span className="c">Bb</span>              <span className="c">Dm</span></span>
      <span>Aklın olmuş yol göstermiş sana </span>
      <span></span>
      <span><span className="c">F</span></span>
      <span>Bir ömürlük maceranda </span>
      <span><span className="c">C</span></span>
      <span>Hikayeni anlat bana </span>
      <span><span className="c">Bb</span></span>
      <span>Ne anlam verdin sen buna </span>
      <span><span className="c">C</span>                         <span className="c">Bb</span>         </span>
      <span>Ruhunda neler var senin </span>
      <span></span>
      <span><span className="c">Dm</span></span>
      <span>Korkma ondan bundan </span>
      <span><span className="c">F</span>                         <span className="c">C</span></span>
      <span>Ne ölümden ne hayattan </span>
      <span><span className="c">Dm</span></span>
      <span>Bu dünyada gördüklerinin </span>
      <span><span className="c">F</span>                    <span className="c">C</span>   </span>
      <span>Hepsi bir hepsi haktan </span>
      <span></span>
      <span><span className="c">Dm</span></span>
      <span>Atalarına malum olmuş </span>
      <span><span className="c">C</span>                       <span className="c">Bb</span>              <span className="c">Dm</span></span>
      <span>Kitap yazmış anlatmışlar sana </span>
      <span><span className="c">Dm</span></span>
      <span>İmam rahip rehber olmuş </span>
      <span><span className="c">C</span>                      <span className="c">Bb</span>              <span className="c">Dm</span></span>
      <span>Yalan yanlış aktarmışlar sana</span>
      <span></span>
      <span><span className="c">F</span></span>
      <span>Günümüzün dünyasında</span>
      <span><span className="c">C</span></span>
      <span>Hepsi aynı hepsi ala</span>
      <span><span className="c">Bb</span></span>
      <span>İsa Musa Muhammed Buda</span>
      <span><span className="c">C</span>                   <span className="c">Bb</span>                </span>
      <span>Neyin varsa bilmiş senin </span>
      <span></span>
      <span><span className="c">F</span></span>
      <span>İnsanoğlu kendini arar </span>
      <span><span className="c">C</span></span>
      <span>Dünya döner milim milim </span>
      <span><span className="c">Bb</span></span>
      <span>Eğer göçüp gidersen bugün </span>
      <span><span className="c">C</span>                      <span className="c">Bb</span></span>
      <span>Yarım kalan işin var senin</span>
      <span></span>
      <span><span className="c">Dm</span></span>
      <span>Korkma ondan bundan </span>
      <span><span className="c">F</span>                         <span className="c">C</span></span>
  ...
  },
  {
    ...
    "title": "Olsun",
    "chordsHTML": (<pre data-key="G#m" className="chords" id="key"><span>Intro:</span>
      <span><span className="c">C</span>    <span className="c">D</span>     <span className="c">G</span>     <span className="c">A#</span>   <span className="c">Am</span></span>
      <span></span>
      <span><span className="c">Am</span>                      </span>
      <span>Yorgun gecelerin ardından</span>
      <span><span className="c">G</span></span>
      <span>Hep aynı yere dönerken</span>
      <span><span className="c">C</span>               <span className="c">E</span>            <span className="c">Am</span></span>
      <span>Islak sokaklar boyu düşündüm</span>
      <span><span className="c">Am</span></span>
      <span>Solmuş insanların yüzünden</span>
      <span><span className="c">G</span></span>
      <span>Gülümseme beklerken</span>
      <span><span className="c">C</span>              <span className="c">E</span>             <span className="c">Am</span></span>
      <span>Tren yolları boyu düşündüm</span>
      <span></span>
      <span><span className="c">F</span>          <span className="c">Am</span>      <span className="c">F</span>             <span className="c">Am</span></span>
      <span>Sanki yıllardır uzaktayım ben</span>
      <span><span className="c">F</span>                <span className="c">Am</span>     <span className="c">F</span>             <span className="c">Am</span></span>
      <span>Özlemlerim hep sensiz derinden</span>
      <span><span className="c">F</span>          <span className="c">Am</span>       <span className="c">F</span>       <span className="c">Am</span></span>
      <span>Ama yalanlar görürüm hala</span>
      <span><span className="c">F</span>               <span className="c">Am</span>            <span className="c">E</span></span>
      <span>Burdan bakınca şu sonsuz dünyaya</span>
      <span></span>
      <span><span className="c">Am</span>           <span className="c">G</span></span>
      <span>Olsun demek de zor artık    </span>
      <span><span className="c">C</span>               <span className="c">E</span>              <span className="c">Am</span>        </span>
      <span>Çocuk düşlerimiz yok artık  </span>
      <span></span>
      <span><span className="c">C</span>    <span className="c">D</span>     <span className="c">G</span>     <span className="c">A#</span>   <span className="c">Am</span></span>
      <span></span>
      <span><span className="c">Am</span></span>
      <span>Erken ölümlerin ardından</span>
      <span><span className="c">G</span></span>
      <span>Hep aynı yere dönerken</span>
      <span><span className="c">C</span>               <span className="c">E</span>          <span className="c">Am</span></span>
      <span>Islak sokaklar boyu düşündüm  </span>
      <span><span className="c">Am</span></span>
      <span>Borcum varmış gibi kendimden</span>
      <span><span className="c">G</span></span>
      <span>Gülümseme beklerken</span>
      <span><span className="c">C</span>             <span className="c">E</span>              <span className="c">Am</span></span>
  ...
  },
  {
    ...
    "chordsHTML": (<pre className="tK8GG Ty_RP" ><span className="y68er">[Verse 1]
        ...
        </span><span className="y68er">Is there anybody in there?
        </span></span><span className="fsG7q"><span className="y68er">                    <span data-name="G" className="fciXY _Oy28" >G</span>      <span data-name="G/F#" className="fciXY _Oy28" >G/F#</span>   <span data-name="Em" className="fciXY _Oy28" >Em</span>
        </span><span className="y68er">Just nod if you can hear me
        </span></span><span className="fsG7q"><span className="y68er">         <span data-name="Bm" className="fciXY _Oy28" >Bm</span>
        </span><span className="y68er">Is there anyone at home?
        </span></span><span className="y68er">
      </span><span className="fsG7q"><span className="y68er"><span data-name="Bsus2" className="fciXY _Oy28" >Bsus2</span>      <span data-name="Bm" className="fciXY _Oy28" >Bm</span>
      </span><span className="y68er">Come on now
        </span></span><span className="fsG7q"><span className="y68er">              <span data-name="A" className="fciXY _Oy28" >A</span>
        </span><span className="y68er">I hear you re feeling down
        </span></span><span className="fsG7q"><span className="y68er"><span data-name="G" className="fciXY _Oy28" >G</span>          <span data-name="G/F#" className="fciXY _Oy28" >G/F#</span>    <span data-name="Em" className="fciXY _Oy28" >Em</span>
        </span><span className="y68er">I can ease your pain
        </span></span><span className="fsG7q"><span className="y68er">            <span data-name="Bm" className="fciXY _Oy28" >Bm</span>
        </span><span className="y68er">And get you on your feet again
        </span></span><span className="y68er">
      </span><span className="fsG7q"><span className="y68er"><span data-name="Bsus2" className="fciXY _Oy28" >Bsus2</span>  <span data-name="Bm" className="fciXY _Oy28" >Bm</span>
      </span><span className="y68er">Relax
        </span></span><span className="fsG7q"><span className="y68er">                    <span data-name="A" className="fciXY _Oy28" >A</span>
        </span><span className="y68er">I ll need some information first
        </span></span><span className="fsG7q"><span className="y68er"><span data-name="G" className="fciXY _Oy28" >G</span>             <span data-name="G/F#" className="fciXY _Oy28" >G/F#</span> <span data-name="Em" className="fciXY _Oy28" >Em</span>
        </span><span className="y68er">Just the basic facts
        </span></span><span className="fsG7q"><span className="y68er">        <span data-name="Bm" className="fciXY _Oy28" >Bm</span>
        </span><span className="y68er">Can you show me where it hurts?
        </span></span><span className="y68er">
      </span><span className="y68er">[Chorus]
      </span><span className="fsG7q"><span className="y68er"><span data-name="D" className="fciXY _Oy28" >D</span>                           <span data-name="A" className="fciXY _Oy28" >A</span>
      </span><span className="y68er">There is no pain, you are receding
        </span></span><span className="fsG7q"><span className="y68er"><span data-name="D" className="fciXY _Oy28" >D</span>                             <span data-name="A" className="fciXY _Oy28" >A</span>
        </span><span className="y68er">A distant ship smoke on the horizon
        </span></span><span className="fsG7q"><span className="y68er"><span data-name="G/B" className="fciXY _Oy28" >G/B</span> <span data-name="C" className="fciXY _Oy28" >C</span>                             <span data-name="G" className="fciXY _Oy28" >G</span>
        </span><span className="y68er">   You are only coming through in waves
        </span></span><span className="fsG7q"><span className="y68er"><span data-name="G/B" className="fciXY _Oy28" >G/B</span> <span data-name="C" className="fciXY _Oy28" >C</span>                                       <span data-name="G" className="fciXY _Oy28" >G</span>
        </span><span className="y68er">   Your lips move but I can t hear what you re saying
        </span></span><span className="y68er">
      </span><span className="fsG7q"><span className="y68er">     <span data-name="D" className="fciXY _Oy28" >D</span>                     <span data-name="A" className="fciXY _Oy28" >A</span>
      </span><span className="y68er">When I was a child I had a fever
        </span></span><span className="fsG7q"><span className="y68er">   <span data-name="D" className="fciXY _Oy28" >D</span>                           <span data-name="A" className="fciXY _Oy28" >A</span>
        </span><span className="y68er">My hands felt just like two balloons
        </span></span><span className="fsG7q"><span className="y68er"><span data-name="G/B" className="fciXY _Oy28" >G/B</span> <span data-name="C" className="fciXY _Oy28" >C</span>                             <span data-name="G" className="fciXY _Oy28" >G</span>
        </span><span className="y68er">  Now I ve got that feeling once again, I can t explain,
        </span></span><span className="fsG7q"><span className="y68er">          <span data-name="G/B" className="fciXY _Oy28" >G/B</span> <span data-name="C" className="fciXY _Oy28" >C</span>                             <span data-name="G" className="fciXY _Oy28" >G</span>
        </span><span className="y68er">You would not understand, this is not how I am
        </span></span><span className="y68er">
      </span><span className="fsG7q"><span className="y68er"><span data-name="A" className="fciXY _Oy28" >A</span>   <span data-name="G/B" className="fciXY _Oy28" >G/B</span>  <span data-name="Cadd9" className="fciXY _Oy28" >Cadd9</span>         <span data-name="G" className="fciXY _Oy28" >G</span>                <span data-name="D" className="fciXY _Oy28" >D</span>
      </span><span className="y68er">I               have become comfortably numb
        </span></span><span className="y68er">
      </span><span className="y68er">[Guitar Solo 1]
      </span><span className="y68er"><span data-name="D" className="fciXY _Oy28" >D</span>  <span data-name="A" className="fciXY _Oy28" >A</span>  <span data-name="D" className="fciXY _Oy28" >D</span>  <span data-name="A" className="fciXY _Oy28" >A</span>  <span data-name="C" className="fciXY _Oy28" >C</span>  <span data-name="G" className="fciXY _Oy28" >G</span>  <span data-name="C" className="fciXY _Oy28" >C</span>  <span data-name="G" className="fciXY _Oy28" >G</span>
      </span><span className="fsG7q"><span className="y68er"><span data-name="A" className="fciXY _Oy28" >A</span>   <span data-name="G/B" className="fciXY _Oy28" >G/B</span> <span data-name="C" className="fciXY _Oy28" >C</span>        <span data-name="G" className="fciXY _Oy28" >G</span>                <span data-name="D" className="fciXY _Oy28" >D</span>
      </span><span className="y68er">I         have become comfortably numb
        </span></span><span className="y68er">
      </span><span className="y68er">[Verse 2]
      </span><span className="fsG7q"><span className="y68er"><span data-name="Bsus2" className="fciXY _Oy28" >Bsus2</span>  <span data-name="Bm" className="fciXY _Oy28" >Bm</span>
      </span><span className="y68er">O.K.
        </span></span><span className="fsG7q"><span className="y68er">              <span data-name="A" className="fciXY _Oy28" >A</span>
        </span><span className="y68er">Just a little pinprick
        </span></span><span className="fsG7q"><span className="y68er">                    <span data-name="G" className="fciXY _Oy28" >G</span>    <span data-name="Em" className="fciXY _Oy28" >Em</span>
        </span><span className="y68er">There ll be no more aaaaaaaah!
        </span></span><span className="fsG7q"><span className="y68er">            <span data-name="Bm" className="fciXY _Oy28" >Bm</span>
        </span><span className="y68er">But you may feel a little sick
        </span></span><span className="y68er">
      </span><span className="fsG7q"><span className="y68er"><span data-name="Bsus2" className="fciXY _Oy28" >Bsus2</span>         <span data-name="Bm" className="fciXY _Oy28" >Bm</span>
      </span><span className="y68er">Can you stand up?
        </span></span><span className="fsG7q"><span className="y68er">                  <span data-name="A" className="fciXY _Oy28" >A</span>
        </span><span className="y68er">I do believe it s working, good
        </span></span><span className="fsG7q"><span className="y68er">                 <span data-name="G" className="fciXY _Oy28" >G</span>                  <span data-name="Em" className="fciXY _Oy28" >Em</span>
        </span><span className="y68er">That ll keep you going through the show
        </span></span><span className="fsG7q"><span className="y68er">     <span data-name="Bm" className="fciXY _Oy28" >Bm</span>
        </span><span className="y68er">Come on, it s time to go
        </span></span><span className="y68er">
      </span><span className="y68er">[Chorus]
      </span><span className="fsG7q"><span className="y68er"><span data-name="D" className="fciXY _Oy28" >D</span>                           <span data-name="A" className="fciXY _Oy28" >A</span>
      </span><span className="y68er">There is no pain, you are receding
        ...
        </span><span className="y68er">    Your lips move but I cant hear what you re saying
        </span></span><span className="y68er">
      </span><span className="fsG7q"><span className="y68er">     <span data-name="D" className="fciXY _Oy28" >D</span>                         <span data-name="A" className="fciXY _Oy28" >A</span>
      </span><span className="y68er">When I was a child, I caught a fleeting glimpse
        </span></span><span className="fsG7q"><span className="y68er"><span data-name="D" className="fciXY _Oy28" >D</span>                       <span data-name="A" className="fciXY _Oy28" >A</span>
        </span><span className="y68er">Out of the corner of my eye
        </span></span><span className="fsG7q"><span className="y68er"><span data-name="G/B" className="fciXY _Oy28" >G/B</span> <span data-name="C" className="fciXY _Oy28" >C</span>                           <span data-name="G" className="fciXY _Oy28" >G</span>
        </span><span className="y68er">    I turned to look but it was gone
        </span></span><span className="fsG7q"><span className="y68er">                   <span data-name="G/B" className="fciXY _Oy28" >G/B</span> <span data-name="C" className="fciXY _Oy28" >C</span>
        </span><span className="y68er">I cannot put my finger on it now
        </span></span><span className="fsG7q"><span className="y68er">                        <span data-name="G" className="fciXY _Oy28" >G</span>
        </span><span className="y68er">The child is grown, the dream is gone
        </span></span><span className="y68er">
      </span><span className="fsG7q"><span className="y68er"><span data-name="Asus4" className="fciXY _Oy28" >Asus4</span>   <span data-name="A" className="fciXY _Oy28" >A</span>  <span data-name="G/B" className="fciXY _Oy28" >G/B</span>  <span data-name="Cadd9" className="fciXY _Oy28" >Cadd9</span>    <span data-name="G" className="fciXY _Oy28" >G</span>                <span data-name="D" className="fciXY _Oy28" >D</span>
      </span><span className="y68er">And  I           have become comfortably numb
        </span></span><span className="y68er">
      </span><span className="y68er">[Guitar Solo 2]
      </span><span className="fsG7q"><span className="y68er"><span data-name="Bm" className="fciXY _Oy28" >Bm</span> <span data-name="A" className="fciXY _Oy28" >A</span> <span data-name="G" className="fciXY _Oy28" >G</span> <span data-name="Em" className="fciXY _Oy28" >Em</span> <span data-name="Bm" className="fciXY _Oy28" >Bm</span>
      </span><span className="y68er">(Repeat and fade)
  ...
  },
  {
    ...
    "chordsHTML": (<pre data-key="D" className="chords" id="key"><span><span className="c">F#m</span>                 <span className="c">D</span></span>
      <span>Aklım başımda değil ki </span>
      <span><span className="c">Bm</span>                <span className="c">A</span>      </span>
      <span>Sebebini bilmiyorum </span>
      <span><span className="c">F#m</span>                 <span className="c">D</span></span>
      <span>Bize nazar değdi inan </span>
      <span><span className="c">Bm</span>               <span className="c">A</span></span>
      <span>Adım gibi biliyorum </span>
      <span></span>
      <span><span className="c">Bm</span>    <span className="c">A</span>        <span className="c">D</span>          <span className="c">Bm</span></span>
      <span>Yine bana haram geceler </span>
      <span><span className="c">A</span>                <span className="c">G</span>      <span className="c">F#m</span></span>
      <span>Senin için ağlıyorum </span>
      <span><span className="c">Bm</span>             <span className="c">A</span>        <span className="c">D</span>          <span className="c">Bm</span></span>
      <span>Yar yine bana haram geceler </span>
      <span><span className="c">A</span>                <span className="c">G</span>      <span className="c">F#m</span></span>
      <span>Senin için ağlıyorum </span>
      <span></span>
      <span><span className="c">Bm</span>    <span className="c">A</span>     <span className="c">G</span>    <span className="c">F#m</span></span>
      <span></span>
      <span><span className="c">Bm</span>     <span className="c">A</span>       <span className="c">G</span>      <span className="c">F#m</span></span>
      <span>Yanıyorum yanıyorum </span>
      <span><span className="c">Bm</span>         <span className="c">A</span>         <span className="c">G</span>      <span className="c">F#m</span></span>
      <span>Ah yanıyorum yanıyorum </span>
      <span><span className="c">Bm</span>             <span className="c">A</span>        <span className="c">D</span>          <span className="c">Bm</span></span>
      <span>Yar yine bana haram geceler </span>
      <span><span className="c">A</span>                <span className="c">G</span>      <span className="c">F#m</span></span>
  ...
  },
  {
    ...
    "chordsHTML": (<pre data-key="Am" className="chords" id="key"><span><span className="c">F</span>  <span className="c">G</span>  <span className="c">Am</span></span>
      ...
      <span>Çok uzun zaman önce</span>
      <span><span className="c">F</span>                  <span className="c">G</span>                <span className="c">Am</span></span>
      <span>Beni düşürdün tuzağına</span>
      <span><span className="c">F</span>                  <span className="c">G</span>                      <span className="c">Am</span></span>
      <span>Benim için başka bir yol yok</span>
      <span><span className="c">F</span>                     <span className="c">G</span>         <span className="c">Am</span></span>
      <span>Sen ya da hiç   sen ya da hiç</span>
      <span></span>
      <span><span className="c">F</span>  <span className="c">G</span>  <span className="c">Am</span></span>
      <span></span>
      <span><span className="c">F</span>                 <span className="c">G</span>                           <span className="c">Am</span></span>
      <span>Bir yol aradım bazen kendime</span>
      <span><span className="c">F</span>                   <span className="c">G</span>             <span className="c">Am</span></span>
      <span>Hep hüzün var elimde</span>
      <span><span className="c">F</span>               <span className="c">G</span>                                <span className="c">Am</span>          </span>
      <span>Seni kaybetmekten korkmak çok zor</span>
      <span><span className="c">F</span>                     <span className="c">G</span>         <span className="c">Am</span></span>
      <span>Sen ya da hiç   sen ya da hiç</span>
      <span></span>
      <span>x2</span>
      <span><span className="c">F</span>             <span className="c">G</span>                     <span className="c">Am</span>    </span>
      <span>Bir köle oldum senin aşkına</span>
      <span>      <span className="c">F</span>                  <span className="c">G</span>          <span className="c">Am</span>    </span>
      <span>Bir köle oldum senin aşkına</span>
      <span></span>
      <span><span className="c">F</span>        <span className="c">G</span>                               <span className="c">Am</span></span>
      <span>Bir erkek ne ister hayatında</span>
      <span><span className="c">F</span>                     <span className="c">G</span>                 <span className="c">Am</span></span>
      <span>Biraz şefkat biraz tutku hepsi bu</span>
      <span><span className="c">F</span>                           <span className="c">G</span>                 <span className="c">Am</span></span>
      <span>Bana vereceğin tek şey bu dünyada</span>
      <span><span className="c">F</span>                       <span className="c">G</span>               <span className="c">Am</span></span>
      <span>Haydi durma, haydi durma</span>
      <span></span>
      <span>N</span></pre>)
  },
  {
    ...
    "chordsHTML": (<pre className="tK8GG Ty_RP" ><span className="y68er">[Intro]
    </span><span className="y68er"><span data-name="Em" className="fciXY _Oy28" >Em</span> <span data-name="D" className="fciXY _Oy28" >D</span> <span data-name="F#" className="fciXY _Oy28" >F#</span> <span data-name="B" className="fciXY _Oy28" >B</span> <span data-name="Asus4" className="fciXY _Oy28" >Asus4</span> <span data-name="F#7" className="fciXY _Oy28" >F#7</span>
      </span><span className="y68er"><span data-name="Bm" className="fciXY _Oy28" >Bm</span> <span data-name="G" className="fciXY _Oy28" >G</span> <span data-name="F#" className="fciXY _Oy28" >F#</span>
      </span><span className="y68er"><span data-name="Bm" className="fciXY _Oy28" >Bm</span> <span data-name="G" className="fciXY _Oy28" >G</span> <span data-name="F#" className="fciXY _Oy28" >F#</span>
      </span><span className="y68er">
      </span><span className="y68er">[Verse 1]
      </span><span className="fsG7q"><span className="y68er"><span data-name="Bm" className="fciXY _Oy28" >Bm</span>      <span data-name="G" className="fciXY _Oy28" >G</span>           <span data-name="F#" className="fciXY _Oy28" >F#</span>
      </span><span className="y68er">Güneş doğar güneş batar
        </span></span><span className="fsG7q"><span className="y68er"><span data-name="Bm" className="fciXY _Oy28" >Bm</span>        <span data-name="G" className="fciXY _Oy28" >G</span>        <span data-name="F#" className="fciXY _Oy28" >F#</span>
        </span><span className="y68er">Ama insan uyumaz bazen, düşünür
        </span></span><span className="fsG7q"><span className="y68er"><span data-name="Bm" className="fciXY _Oy28" >Bm</span>      <span data-name="G" className="fciXY _Oy28" >G</span>            <span data-name="F#" className="fciXY _Oy28" >F#</span>
        </span><span className="y68er">Geceler kısa çabuk geçer
        </span></span><span className="fsG7q"><span className="y68er"><span data-name="Bm" className="fciXY _Oy28" >Bm</span>        <span data-name="G" className="fciXY _Oy28" >G</span>        <span data-name="F#" className="fciXY _Oy28" >F#</span>
        </span><span className="y68er">Ama insan uyumaz bazen, düşünür
        </span></span><span className="y68er">
      </span><span className="y68er">[Verse 2]
      </span><span className="fsG7q"><span className="y68er"><span data-name="A" className="fciXY _Oy28" >A</span>        <span data-name="C#m" className="fciXY _Oy28" >C#m</span>          <span data-name="G" className="fciXY _Oy28" >G</span>
      </span><span className="y68er">Deniz masmavidir ne güzel
        </span></span><span className="fsG7q"><span className="y68er">         <span data-name="Bm" className="fciXY _Oy28" >Bm</span>           <span data-name="A" className="fciXY _Oy28" >A</span>
        </span><span className="y68er">Ama insanlar görmez bazen
        </span></span><span className="fsG7q"><span className="y68er"><span data-name="A" className="fciXY _Oy28" >A</span>       <span data-name="C#m" className="fciXY _Oy28" >C#m</span>           <span data-name="G" className="fciXY _Oy28" >G</span>
        </span><span className="y68er">Şiirler şarkılar masallar
        </span></span><span className="fsG7q"><span className="y68er">         <span data-name="Bm" className="fciXY _Oy28" >Bm</span>           <span data-name="A" className="fciXY _Oy28" >A</span>
        </span><span className="y68er">Ama insanlar duymaz bazen
        </span></span><span className="fsG7q"><span className="y68er">      <span data-name="G" className="fciXY _Oy28" >G</span>                 <span data-name="Bm" className="fciXY _Oy28" >Bm</span>
        </span><span className="y68er">Üzme kendini, ümitsiz gibi
        </span></span><span className="fsG7q"><span className="y68er"><span data-name="F" className="fciXY _Oy28" >F</span>                     <span data-name="Em" className="fciXY _Oy28" >Em</span>
        </span><span className="y68er">Sevenin var, bak ne güzel
        </span></span><span className="y68er">
      </span><span className="y68er">[Solo]
      </span><span className="y68er"><span data-name="Bm" className="fciXY _Oy28" >Bm</span> <span data-name="G#" className="fciXY _Oy28" >G#</span> <span data-name="G" className="fciXY _Oy28" >G</span> <span data-name="F#" className="fciXY _Oy28" >F#</span>
      </span><span className="y68er"><span data-name="Bm" className="fciXY _Oy28" >Bm</span> <span data-name="G#" className="fciXY _Oy28" >G#</span> <span data-name="G" className="fciXY _Oy28" >G</span> <span data-name="F#" className="fciXY _Oy28" >F#</span>
      </span><span className="y68er">
      </span><span className="y68er">[Verse 3]
      </span><span className="fsG7q"><span className="y68er"><span data-name="A" className="fciXY _Oy28" >A</span>        <span data-name="C#m" className="fciXY _Oy28" >C#m</span>          <span data-name="G" className="fciXY _Oy28" >G</span>
      ...
      </span><span className="y68er">[Verse 4]
      </span><span className="fsG7q"><span className="y68er"><span data-name="Bm" className="fciXY _Oy28" >Bm</span>      <span data-name="G" className="fciXY _Oy28" >G</span>           <span data-name="F#" className="fciXY _Oy28" >F#</span>
      </span><span className="y68er">Güneş doğar güneş batar
        </span></span><span className="fsG7q"><span className="y68er"><span data-name="Bm" className="fciXY _Oy28" >Bm</span>        <span data-name="G" className="fciXY _Oy28" >G</span>        <span data-name="F#" className="fciXY _Oy28" >F#</span>
        </span><span className="y68er">Ama insan uyumaz bazen, düşünür
  ...
  },
  {
    ...
    </span><span className="y68er">Title: Benimle Uçmak İster Misin?
      </span><span className="y68er">Tabbed by: Tuvan Soykan
      </span><span className="y68er">
      </span><span className="y68er">Tuning: Standard
      </span><span className="y68er">
      </span><span className="y68er">YAVUZ ÇETİN - BENİMLE UÇMAK İSTER MİSİN?
      </span><span className="y68er">
      </span><span className="y68er">Capo: 3rd fret
      </span><span className="y68er">
      </span><span className="fsG7q"><span className="y68er">[Intro]
      </span><span className="y68er">e|---------------------------------------------|
        </span><span className="y68er">B|--------1---------------3-----------5-3-1----|
        </span><span className="y68er">G|------0-------0-------0-------0-----5-4-0----|
        </span><span className="y68er">D|----2-----0h2-------4-----0h4-------5-5-2----|
        </span><span className="y68er">A|--0---------------0--------------------------|
        </span><span className="y68er">E|---------------------------------------------|
        </span></span><span className="y68er">
      </span><span className="y68er">[Verse]
      </span><span className="fsG7q"><span className="y68er"><span data-name="Am7" className="fciXY _Oy28" >Am7</span>          <span data-name="D" className="fciXY _Oy28" >D</span>                  <span data-name="Am7" className="fciXY _Oy28" >Am7</span>  <span data-name="D" className="fciXY _Oy28" >D</span>
      </span><span className="y68er">  Benimle uçmak ister misin bu gece?
        </span></span><span className="fsG7q"><span className="y68er"><span data-name="Am7" className="fciXY _Oy28" >Am7</span>          <span data-name="D" className="fciXY _Oy28" >D</span>                   <span data-name="Am7" className="fciXY _Oy28" >Am7</span>  <span data-name="D" className="fciXY _Oy28" >D</span>
        </span><span className="y68er">  Yükseklerde olmaktan korkar mısın?
        </span></span><span className="fsG7q"><span className="y68er"><span data-name="Am7" className="fciXY _Oy28" >Am7</span>          <span data-name="D" className="fciXY _Oy28" >D</span>                   <span data-name="Am7" className="fciXY _Oy28" >Am7</span>  <span data-name="D" className="fciXY _Oy28" >D</span>
        </span><span className="y68er">  Topraktan ayrılalım bir süre için
        </span></span><span className="fsG7q"><span className="y68er"><span data-name="Am7" className="fciXY _Oy28" >Am7</span>               <span data-name="D" className="fciXY _Oy28" >D</span>                   <span data-name="Am7" className="fciXY _Oy28" >Am7</span>    <span data-name="D" className="fciXY _Oy28" >D</span>
        </span><span className="y68er">  Dünya bir yere kaçmaz biz yüzerken göklerde
        </span></span><span className="y68er">
      </span><span className="y68er">[Chorus]
      </span><span className="fsG7q"><span className="y68er"><span data-name="F" className="fciXY _Oy28" >F</span> <span data-name="G" className="fciXY _Oy28" >G</span>           <span data-name="Am" className="fciXY _Oy28" >Am</span>  <span data-name="F" className="fciXY _Oy28" >F</span>       <span data-name="G" className="fciXY _Oy28" >G</span>            <span data-name="Am" className="fciXY _Oy28" >Am</span>
      </span><span className="y68er"> Gel benimle ol,   unut bütün dertlerini
        </span></span><span className="fsG7q"><span className="y68er"><span data-name="F" className="fciXY _Oy28" >F</span>    <span data-name="G" className="fciXY _Oy28" >G</span>           <span data-name="Am" className="fciXY _Oy28" >Am</span>        <span data-name="F" className="fciXY _Oy28" >F</span>          <span data-name="G" className="fciXY _Oy28" >G</span>          <span data-name="D" className="fciXY _Oy28" >D</span>
        </span><span className="y68er"> Rüzgar bizi bekler, daha fazla vakit kaybetmeyelim
        </span></span><div className="LJhrL">X</div></pre>)
  }
]